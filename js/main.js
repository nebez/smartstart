...
function activateUsedTileColors() {
    ...
    $(".tilecolorselector").children().filter(function () {
        return $(this).css('background-color').toLowerCase() == $(this).parents(".box").attr("data-tilecolor").toLowerCase();
    }).addClass("active");
}
...
function updateBookmarks() {
    ...
    var encbookmarks = Base64.encode(JSON.stringify({
        "bookmarks": bookmarks
    }));
